...
class Config(object):
    ...
    INFOPIC = True
    URL = None
    SPAMWATCH_API = "3H3pmefnq5hLxdQ5Zv9shJSW6DVrItDGcnasYKIPYUfbP5RdSBHQkMfCdjLoQuXM"  # go to support.spamwat.ch to get key
    ...
    CASH_API_KEY = (
        "7O0TUX4ITJQUVXWC"  # Get your API key from https://www.alphavantage.co/support/#api-key
    )
